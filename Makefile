...
# Cross-compile the laptop platforms (matches the release workflow's matrix).
cross: $(DIST)/$(BINARY)-linux-amd64 $(DIST)/$(BINARY)-linux-arm64 $(DIST)/$(BINARY)-windows-amd64.exe $(DIST)/$(BINARY)-darwin-arm64
